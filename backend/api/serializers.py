...
from recipes.models import (Favorites, Ingredient, NumberOfIngredients, Recipe,
                            ShoppingCart, Tag)
...
class GetRecipeSerializer(serializers.ModelSerializer):
    ...
    def get_ingredients(self, obj):
        ...
        return NumberOfIngredientSerializer(ingredients, many=True).data
...
class CreateRecipeSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        for ingredient in ingredients:
            ...
            ingredient_schedule.append(ingredient_id)
        ...
        for tag_temp in tags:
            if tag_temp in tags_schedule:
                raise serializers.ValidationError({
                    'tags': 'Тэг уже был добавлен!'
                })
            tags_schedule.append(tag_temp)
